  ...
  return (
    <div className="box-border flex relative flex-col shrink-0 px-0 py-20 mt-5 rounded-2xl bg-zinc-100">
      <div className="mb-16 text-center">
        <p className="mb-4 text-sm font-medium tracking-wider text-emerald-600 uppercase">
          How It Works
        </p>
      ...
      <div className="grid relative gap-10 px-10 py-0 mx-auto my-0 grid-cols-[repeat(auto-fit,minmax(280px,1fr))] max-w-[1000px] max-md:gap-16 max-md:grid-cols-[1fr]">
        <div className="absolute top-20 h-0.5 bg-emerald-900 bg-center bg-no-repeat bg-cover bg-[url(https://encycolorpedia.com/004646)] inset-x-[33%] max-md:hidden" />
        <div className="relative px-8 py-10 text-center rounded-2xl border border-solid transition-all border-emerald-600 border-opacity-10 duration-[0.3s] ease-[ease] shadow-[0_10px_30px_rgba(0,70,70,0.08)]">
