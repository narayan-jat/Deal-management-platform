...
import { DollarSign, Building2, CreditCard, FileText } from 'lucide-react';
import { formatCurrency } from '@/utility/Utility';
import { FinancialAssetsCollateralItem, DebtDetails } from '@/types/deal/Deal.sections';

interface FinancialAssetsCollateralRendererProps {
  item: FinancialAssetsCollateralItem;
  index: number;
  onDocumentPreview?: (document: any) => void;
  onDocumentDownload?: (document: any) => void;
}

export const FinancialAssetsCollateralRenderer: React.FC<FinancialAssetsCollateralRendererProps> = ({
  item,
  index,
  onDocumentPreview,
  onDocumentDownload
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {item.custodianHolder && (
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700">Custodian/Holder</p>
        ...
        {item.lienStatus && (
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700">Lien Status</p>
