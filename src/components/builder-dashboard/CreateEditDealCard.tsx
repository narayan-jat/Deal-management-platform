...
export default function CreateEditDealCard({
  ...
  return (
    <>
      <div
        className={cn(
          "fixed inset-0 z-50 flex items-start justify-end transition-all duration-300 ease-in-out",
      ...
      >
        ...
        <div
          className={cn(
            "relative w-full max-w-md h-screen bg-white shadow-2xl transform transition-transform duration-300 ease-in-out",
            "flex flex-col",
